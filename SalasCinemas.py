...
lugares_vagos = [10, 2, 1, 3, 0] # na sala 0 temos 10 poltronas vazias. Na sala 1 temos 2 poltronas vazias etc...
while True:
    ...
    if sala > len(lugares_vagos) or sala < 1:
        ...
        lugares = int(input(
            "Quantos lugares você deseja (%d vagos):" % lugares_vagos[sala-1]))
